...
This workflow assumes that you generated a [Qualtrics API key](https://api.qualtrics.com/ZG9jOjg3NjYzMg-api-key-authentication) and saved it securely with `keyring::key_set("qualtrics_api_key")` in your OS's secure secret store. In addition, request access to the Qualtrics "CPSC 320 worksheets survey" from Stephan Koenig.
