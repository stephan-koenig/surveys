...
**You must complete the entire survey to be awarded the bonus.**
...
- [ ] I do not want my responses linked my identity for analysis (my student number will only be used to assign course credit for completing the survey).
...
5.  Over the last month, during periods dedicated to working in small groups on worksheets, how often did you spend your time on one of the following approaches?
    **Note:** Discussing a question with other members of your group counts as working on the worksheet.
    ...
    ```
    * Never or rarely * Infrequently * Between 1/3rd to 2/3rds of the time * Often * Almost always or always
    ```
